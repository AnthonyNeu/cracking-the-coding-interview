/* Question 5.3 Given a positive integer, print the next smallest and the next largest number that have the same number of 1bits in their binary representation.
 */
...
public class Question {
    //a slow method simply add one or subtract one once and try to get the same number of 1bits in binary representation.
    ...
    public static int getNext(int n) {
        //c0 to count the number of zeros
        //c1 to count the number of ones
        int c = n;
        int c0 = 0;
        int c1 = 0;
